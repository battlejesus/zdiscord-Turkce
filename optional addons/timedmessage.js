...
class TimedMessage {
    ...
    async post() {
        try {
            ...
            embed.setTitle("Sunucu Durumu")
                .setColor("#f2449e")
                .setDescription(`**Çalışma Süresi:** ${(GetGameTimer() / 1000 / 60).toFixed(2)} dakika
                **Sunucu IP:** ${this.z.config.FiveMServerIP}
                **Çevrimiçi Oyuncular:** ${GetNumPlayerIndices()}/${GetConvar("sv_maxClients", "64")}
                **Discord Daveti:** ${this.z.config.DiscordInviteLink}`);
